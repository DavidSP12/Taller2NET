    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<Enrollment>(e =>
        {
            ...
            e.HasOne(en => en.Course).WithMany(c => c.Enrollments)
             .HasForeignKey(en => en.CourseId).OnDelete(DeleteBehavior.Restrict);
        });
        ...
        modelBuilder.Entity<Attendance>(e =>
        {
            ...
            e.HasOne(a => a.Enrollment).WithMany(en => en.Attendances)
             .HasForeignKey(a => a.EnrollmentId).OnDelete(DeleteBehavior.Cascade);
        });
        ...
        modelBuilder.Entity<Grade>(e =>
        {
            ...
            e.HasOne(g => g.Enrollment).WithMany(en => en.Grades)
             .HasForeignKey(g => g.EnrollmentId).OnDelete(DeleteBehavior.Cascade);
        });
    }
}
